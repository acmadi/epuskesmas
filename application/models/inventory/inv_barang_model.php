...
class Inv_barang_model extends CI_Model {
    ...
    {
        $query = $this->db->get("get_all_inventaris",$limit,$start);
        return $query->result();
    }
