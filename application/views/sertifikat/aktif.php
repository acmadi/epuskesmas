        ...
        <div class="box-body">
            <table id="dataTable" class="table table-bordered table-hover">
              ...
              <?php 
                ...
                <?php if($user_level == "super administrator") { ?>
                    <td align="center"><a class="btn btn-primary btn-xs" href="<?php echo base_url()."sertifikat/aktif_detail/".$row['kode_permohonan']."/".$row['kode_varietas']."/".$row['kode_komoditi'];?>" title="Detail">Detail</a></td>
                  <?php } ?>
              </tr>
                <?php endforeach;?>                    
			     	</tbody>
...
<script>
	$(function () {	
        $("#dataTable").dataTable();
		$("#menu_sertifikat_aktif").addClass("active");
