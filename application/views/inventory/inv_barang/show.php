	   ...
	   var source = { 
		...
		{	
			...
			<?php if(!isset($viewreadonly)){?>	{ text: 'Edit', align: 'center', filtertype: 'none', sortable: false,editable: false, width: '5%', cellsrenderer: function (row) {
				...
				{ text: 'Satuan Barang',editable: false, datafield: 'pilihan_satuan_barang', columntype: 'textbox', filtertype: 'textbox', width: '10%'},
				{ text: 'Hak', editable: false,datafield: 'pilihan_status_hak', columntype: 'textbox', filtertype: 'textbox', width: '15%'},
				...
				{ text: 'Pilihan Penggunaan', editable: false,datafield: 'pilihan_penggunaan', columntype: 'textbox', filtertype: 'textbox', width: '15%'}
		...
		{	
			...
			<?php if(!isset($viewreadonly)){?>	{ text: 'Edit', align: 'center', filtertype: 'none', sortable: false,editable: false, width: '5%', cellsrenderer: function (row) {
				...
				{ text: 'Pilihan Bahan', editable: false,datafield: 'pilihan_bahan', columntype: 'textbox', filtertype: 'textbox', width: '15%'},
				{ text: 'Ukuran Barang ', editable: false,datafield: 'ukuran_barang', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
				{ text: 'Satuan Barang ', editable: false,datafield: 'pilihan_satuan', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
		...
		{	
			...
			<?php if(!isset($viewreadonly)){?>	{ text: 'Edit', align: 'center', filtertype: 'none', sortable: false,editable: false, width: '5%', cellsrenderer: function (row) {
				...
				{ text: 'Status Hak', editable: false,datafield: 'pillihan_status_hak', columntype: 'textbox', filtertype: 'textbox', width: '15%'},
				{ text: 'Kode Tanah ', editable: false,datafield: 'nomor_kode_tanah', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
				{ text: 'Kontruksi Tingkat ', editable: false,datafield: 'pilihan_kons_tingkat', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
				{ text: 'Kontruksi Beton ', editable: false,datafield: 'pilihan_kons_beton', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
		...
		{	
			...
			<?php if(!isset($viewreadonly)){?>	{ text: 'Edit', align: 'center', filtertype: 'none', sortable: false,editable: false, width: '5%', cellsrenderer: function (row) {
				...
				{ text: 'Nomor Dokumen ', editable: false,datafield: 'dokumen_nomor', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
				{ text: 'Tanggal Dokumen',editable: false,datafield: 'dokumen_tanggal', columntype: 'date', filtertype: 'date', cellsformat: 'dd-MM-yyyy', width: '10%'},
				{ text: 'Status Tanah ', editable: false,datafield: 'pilihan_status_tanah', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
		...
		{	
			...
			<?php if(!isset($viewreadonly)){?>	{ text: 'Edit', align: 'center', filtertype: 'none', sortable: false,editable: false, width: '5%', cellsrenderer: function (row) {
				...
				{ text: 'Ukuran Flora Fauna ', editable: false,datafield: 'flora_fauna_ukuran', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
				{ text: 'Satuan ', editable: false,datafield: 'pilihan_satuan', columntype: 'textbox', filtertype: 'textbox', width: '13%'},
