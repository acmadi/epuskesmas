	   ...
	   var source = {
		...
		{	
			...
			columns: [
				...
				{ text: 'Nama Barang ', editable: false,datafield: 'nama_barang', columntype: 'textbox', filtertype: 'textbox', width: '20%'},
				{ text: 'Register ', editable: false,datafield: 'register', columntype: 'textbox', filtertype: 'textbox', width: '10%'},
				{ text: 'Tahun ', editable: false,datafield: 'tahun', columntype: 'textbox', filtertype: 'textbox', width: '10%'},
				<?php 
				$w = 35/$n_kondisi;
				foreach($kondisi as $r){ ?>
					{ text: '<?=$r->id?>',  columngroup : 'kondisi',editable: false, datafield: '<?=$r->id?>', columntype: 'textbox', filtertype: 'textbox', width: '<?=$w?>%'},
				<?php } ?>
				
				{ text: 'Harga (Rp)', editable: false,datafield: 'harga', columntype: 'textbox', filtertype: 'textbox', width: '15%',  cellsalign: 'right', cellsformat: 'f'}
