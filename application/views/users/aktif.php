                  ...
                  <table id="dataTable" class="table table-bordered table-hover">
					...
					foreach($query as $row):?>
						<tr>
							...
							<td align="center"><a class="btn btn-success btn-xs" href="<?php  echo base_url()?>users/profile/<?php  echo $row->username?>" title="Detail Account">Detail</a></td>
						</tr>
					<?php endforeach;?>                   
				</tbody>
              </table>
...
<script>
	$(function () {	
        $("#dataTable").dataTable();
		$("#menu_dashboard_penangkar").addClass("active");
