...
<div class="row" style="background:#FAFAFA">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_3" data-toggle="tab">3. Keadaan Kegiatan Pembibitan ( Eksisting )</a></li>
    </ul>
    <div class="tab-content">
      <div class="tab-pane active" id="tab_3">    
        <div class="row">
        <form id="komoditi-form" name="komoditi-form" method="post" action="<?php echo base_url().'users/trup_add_eksisting/'.$kode_trup;?>">
          <div class="col-md-6">
