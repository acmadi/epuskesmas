...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn-cancel-approval').click(function(){
          $('#btn-cancel-approval').text('Loading...');
          $('#btn-cancel-approval').addClass('disabled');
          $('#btn-back').addClass('disabled');
          $.ajax({ 
            type: "GET",
            url: "<?php echo base_url()?>users/doapprove/<?php echo $username; ?>/0",
            success: function(response){
              if(response=="1"){
                $('#status-label').html('Status anggota : <strong>Pendaftar Baru</strong>');
                $('#btn-cancel-approval').remove();
                $('#btn-back').removeClass('disabled');
               }else{
                 $('#status-label').text('Proses cancel approval gagal, status anggota masih approved');
                 $('#btn-cancel-approval').text('Cancel');
                 $('#btn-cancel-approval').removeClass('disabled');
                 $('#btn-back').removeClass('disabled');
               }
            }
           });    
...
<div class="row" style="background:#FAFAFA">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      ...
      <li><a href="#tab_2" data-toggle="tab">Galeri Foto</a></li>
    </ul>
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="tab_1">    
          ...
          <p class="login-box-msg">Silahkan periksa kembali kelengkapan data profil calon anggota :</p>
           ...
           <br>
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Nama Jenis Usaha / Perusahaan" name="perusahaan" readonly value="<?php 
        ...
        <div class="col-md-4 ">
            <div class="row">
                <p id="status-label" class="login-box-msg">Status anggota : <strong>Approved</strong></p>
	    	    <div class="col-md-5 col-md-offset-3">
		            <div class="row">
                    <button type="button" id="btn-cancel-approval" class="btn btn-danger btn-block btn-social "><i class="fa fa-undo"></i>Cancel</button><br>
...
$(function(){
    ...
    $("#btn-back").click(function(){
    	document.location.href="<?php echo base_url()?>users/aktif";
    });
