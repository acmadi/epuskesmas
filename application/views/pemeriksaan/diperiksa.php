                  ...
                  <table id="dataTable" class="table table-bordered table-hover">
	                ...
	                foreach($pemeriksaan as $row):?>
	                  <tr>
	                    ...
	                    <?php if($user_level == "administrator" || $user_level == "super administrator") { ?>
	                    <td align="center"><a class="btn btn-primary btn-xs" href="<?php echo base_url()."pemeriksaan/diperiksa_detail/".$row['kode_permohonan'];?>" title="Detail Account">Detail</a></td>
	                  <?php } ?>
	                  </tr>
	                <?php endforeach;?>         
				</tbody>
