...
class Tindaklanjut extends CI_Controller {
	...
	function json_evaluasi(){
		die(json_encode($this->tindaklanjut_model->json_tindaklanjut()));
	}

	function json_tindaklanjut(){
		die(json_encode($this->tindaklanjut_model->json_tindaklanjut('tindaklanjut')));
	}

	function json_tidaktindaklanjut(){
		die(json_encode($this->tindaklanjut_model->json_tindaklanjut('tidak')));
	}

	function json_rekomendasi(){
		die(json_encode($this->tindaklanjut_model->json_rekomendasi('rekomendasi')));
	}

	function json_tidakrekomendasi(){
		die(json_encode($this->tindaklanjut_model->json_rekomendasi('tidak')));
	}

	function json_produk_cfs($id_sertifikasi){
		die(json_encode($this->tindaklanjut_model->json_produk_cfs($id_sertifikasi)));
	}

	function json_persyaratan_cfs($id_sertifikasi,$id_product){
		die(json_encode($this->tindaklanjut_model->json_persyaratan_cfs($id_sertifikasi,$id_product)));
	}
	function json_lampiran_cfs($id_sertifikasi){
		die(json_encode($this->tindaklanjut_model->json_lampiran_cfs($id_sertifikasi)));
	}

	function lanjut(){
		$this->authentication->verify('tindaklanjut','edit');
		$data['title'] = "Daftar Permohonan: Tindak Lanjut";
		$data['content'] = $this->parser->parse("tindaklanjut/tindaklanjut",$data,true);
	...
	function tidaktindaklanjut(){
		...
		$data['content'] = $this->parser->parse("tindaklanjut/tidaktindaklanjut",$data,true);
		$this->template->show($data,"home");
	}
	...
	function rekomendasi(){
		...
		$data['content'] = $this->parser->parse("tindaklanjut/rekomendasi",$data,true);
		$this->template->show($data,"home");
	}
	...
	function tidakrekomendasi(){
		...
		$data['content'] = $this->parser->parse("tindaklanjut/tidakrekomendasi",$data,true);
		$this->template->show($data,"home");
	}

	function lengkap(){
		$this->authentication->verify('tindaklanjut','edit');
		$data['title'] = "Data Permohonan: Lengkap";
		$data['content'] = $this->parser->parse("tindaklanjut/lengkap",$data,true);
		$this->template->show($data,"home");
	}
	...
	function kelengkapan_benar($id_sertifikasi){
		...
		$data['title'] = "Data Permohonan: Lengkap Tindak Lanjut";
		$data['id_sertifikasi'] = $id_sertifikasi;
		$this->parser->parse("tindaklanjut/kelengkapan_benar",$data);
	}

	function kelengkapan($id_sertifikasi){
		$this->authentication->verify('tindaklanjut','edit');		
		$data = $this->users_model->get_data_row($this->session->userdata('id')); 
		$data['title'] = "Data Permohonan: Tidak Tindak Lanjut";
		$data['id_sertifikasi'] = $id_sertifikasi;
		$this->parser->parse("tindaklanjut/kelengkapan",$data);
	}

	function html_lengkap(){
		$this->authentication->verify('tindaklanjut','edit');		
		$data = $this->tindaklanjut_model->json_tindaklanjut();
		$data['Rows'] = $data[0]['Rows'];
		$this->parser->parse("tindaklanjut/html",$data);
	}
	
	function html_tidaklengkap(){
		$this->authentication->verify('tindaklanjut','edit');		
		$data = $this->tindaklanjut_model->json_evaluator('tidak');
		$data['Rows'] = $data[0]['Rows'];
	...
	function html_tindaklanjut(){
		$this->authentication->verify('tindaklanjut','edit');		
		$data = $this->tindaklanjut_model->json_tindaklanjut('tindaklanjut');
		$data['Rows'] = $data[0]['Rows'];
		$this->parser->parse("tindaklanjut/html",$data);
	}
	...
	function html_tidaktindaklanjut(){
		$this->authentication->verify('tindaklanjut','edit');		
		$data = $this->tindaklanjut_model->json_tidaktindaklanjut('tidak');
		$data['Rows'] = $data[0]['Rows'];
		$this->parser->parse("tindaklanjut/html",$data);
	}
	...
	function html_rekomendasi(){
		$this->authentication->verify('tindaklanjut','edit');		
		$data = $this->tindaklanjut_model->json_rekomendasi('rekomendasi');
		$data['Rows'] = $data[0]['Rows'];
		$this->parser->parse("tindaklanjut/html",$data);
	}
	...
	function html_tidakrekomendasi(){
		$this->authentication->verify('tindaklanjut','edit');		
		$data = $this->tindaklanjut_model->json_tidakrekomendasi('tidak');
		$data['Rows'] = $data[0]['Rows'];
		$this->parser->parse("tindaklanjut/html",$data);
	}
	...
	function html_belumdiperiksa(){
		$this->authentication->verify('tindaklanjut','edit');		
		$data = $this->tindaklanjut_model->json_belumdiperiksa();
		$data['Rows'] = $data[0]['Rows'];
		$this->parser->parse("tindaklanjut/html",$data);
	}
	
	function dodownload_spblp($id_sertifikasi){
		$data = $this->tindaklanjut_model->get_pembayaran($id_sertifikasi); 
	...
	function excel_lengkap(){
		...
		$output_file_name = $path.'export/report_tindaklanjut_lengkap.xlsx';
	...
	function excel_tidaklengkap(){
		...
		$TBS->MergeBlock('data', $rows);
		$output_file_name = $path.'export/report_tindaklanjut_tidaklengkap.xlsx';
		$TBS->Show(OPENTBS_FILE, $output_file_name);
		echo $output_file_name;
	}
	...
	function excel_belumdiperiksa(){
		...
		$TBS->MergeBlock('data', $rows);
		$output_file_name = $path.'export/report_tindaklanjut_belumdiperiksa.xlsx';
		$TBS->Show(OPENTBS_FILE, $output_file_name);
		echo $output_file_name;
	}
	...
	function excel_tindaklanjut(){
		...
		$TBS->MergeBlock('data', $rows);
		$output_file_name = $path.'export/report_tindaklanjut_tindaklanjut.xlsx';
		$TBS->Show(OPENTBS_FILE, $output_file_name);
		echo $output_file_name;
	}
	...
	function excel_tidaktindaklanjut(){
		...
		$TBS->MergeBlock('data', $rows);
		$output_file_name = $path.'export/report_tindaklanjut_tidaktindaklanjut.xlsx';
		$TBS->Show(OPENTBS_FILE, $output_file_name);
		echo $output_file_name;
	}
	...
	function excel_rekomendasi(){
		...
		$TBS->MergeBlock('data', $rows);
		$output_file_name = $path.'export/report_tindaklanjut_rekomendasi.xlsx';
		$TBS->Show(OPENTBS_FILE, $output_file_name);
		echo $output_file_name;
	}
	...
	function excel_tidakrekomendasi(){
		...
		$TBS->MergeBlock('data', $rows);
		$output_file_name = $path.'export/report_tindaklanjut_tidakrekomendasi.xlsx';
		$TBS->Show(OPENTBS_FILE, $output_file_name);
		echo $output_file_name;
	}
	...
	{ 
		...
		$permohonan			= $this->tindaklanjut_model->get_data_row($id); 
		$data				= $this->users_model->get_data_row($permohonan['uid']); 
		$negarax            = $this->tindaklanjut_model->get_data_negara($id); 
		$jenis              = $this->tindaklanjut_model->get_izin_jenis($id);
		$data['title']		= "Evalutor &raquo; Detail";
		$pembayaran			= $this->tindaklanjut_model->get_pembayaran($id); 
		$jenis_permohonan	= $this->tindaklanjut_model->get_jenis_permohonan($id,$permohonan['id_jenis_permohonan']);
		...
		$data['tagih_total']= $this->tindaklanjut_model->get_tagih_total($id); 
		...
		$data['form_produk']		= $this->parser->parse("tindaklanjut/form_".strtolower($jenis_permohonan['kode'])."_lock",$data,true);		
		$data['produk']				= $this->tindaklanjut_model->get_produk($id,$data['id_jenis_permohonan']);
		$data['lampiran_produk']	= $this->parser->parse("tindaklanjut/form_lampiran_produk",$data,true);
 		$data['lampiran']			= $this->tindaklanjut_model->get_lampiran($id,$data['id_jenis_permohonan']);

		$data['form_lampiran']		= $this->parser->parse("tindaklanjut/form_lampiran_lock",$data,true);
		$kelengkapan				= $this->tindaklanjut_model->get_catatan($id); 
		if($data['status_lengkap']=="tidak"){
			$data['form_catatan']	= $this->parser->parse("tindaklanjut/kelengkapan_lock",$kelengkapan,true);
		}else{
			...
			$data['form_catatan']	= $this->parser->parse("tindaklanjut/kelengkapan_lock",$data,true);
		
		}

		echo $this->parser->parse("tindaklanjut/form_lock",$data,true);
	}
	
	
	function doedit_status_lanjut($id_sertifikasi=0, $status="tindaklanjut")
	{
		$this->authentication->verify('tindaklanjut','edit');
		//if(strtolower($status)!="tindaklanjut"){
			...
			if($this->form_validation->run()== FALSE){
				...
				if($this->tindaklanjut_model->insert_catatan($id_sertifikasi,"Tindak Lanjut",$status)){
					//disini kirim email pemberitahuan tidak lengkap dan perintah bayar
					$this->tindaklanjut_model->update_status_lanjut($id_sertifikasi, $status);
					echo "1";
				}else{
					echo "Error";
				}
		...
		/*}else{
			if($this->tindaklanjut_model->update_status_lanjut($id_sertifikasi, $status)){
 				//$this->permohonan_model->update_signature($id_sertifikasi, $status);
 				//disini kirim email pemberitahuan tidak lengkap dan perintah bayar
	...
	function get_formulir($id_sertifikasi,$id_formulir=""){
		...
		if(strtolower($jenis['kode'])=="copp"){
 		...
 		echo  $this->parser->parse("tindaklanjut/formulir_tindaklanjut",$data,true);
